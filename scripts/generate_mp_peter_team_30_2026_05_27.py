...
OUT=ROOT/'assets/mp-peter-team-scenes-2026-05-27-kie'
IMG=OUT/'images'
IMG.mkdir(parents=True, exist_ok=True)

REF_CACHE=OUT/'_refs_local'
REFS={
    'logo': REF_CACHE/'logo.png',
...
brand='''M&P Holzbau documentary image set. Workwear must be burgundy/dark red M&P work jackets or hoodies, dark grey/black work trousers, black safety shoes. Use the supplied official M&P logo as the exact logo reference: only one small believable chest patch or sleeve patch, no fake text, no extra logos, no huge centered branding. If the logo is too small to read, keep it as a subtle exact-color patch rather than inventing letters.'''
...
manifest={'created_at':datetime.now(timezone.utc).isoformat(),'batch':'mp-peter-team-scenes-2026-05-27-kie','model':'nano-banana-2','refs':{k:str(v) for k,v in REFS.items()},'ref_urls':{},'items':[]}
